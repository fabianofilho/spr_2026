"""
DeBERTa Model for Mammography Report Classification
Microsoft's DeBERTa with disentangled attention
"""
...
def train_fold(
    ...
    """Train DeBERTa model for a single fold."""
    ...
    # Training arguments (DeBERTa benefits from lower learning rate)
...
def main():
    parser = argparse.ArgumentParser(description="Train DeBERTa model for mammography classification")
    parser.add_argument("--config", type=str, default="src/configs/deberta_config.yaml")
